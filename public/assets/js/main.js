$(function() {
   ...
   //===== Prealoder
    ...
    $('.testimonials-active').not('.slick-initialized').slick({
        dots: false,
        infinite: true,
        autoplay: true,
        autoplaySpeed: 2000,
    ...
    //===== testimonials slide slick slider
    $('.testimonials-2-active').not('.slick-initialized').slick({
        dots: false,
        infinite: true,
        autoplay: true,
        autoplaySpeed: 2000,
    ...
    //===== testimonials slide slick slider
    $('.testimonials-3-active').not('.slick-initialized').slick({
        dots: false,
        infinite: true,
        autoplay: true,
        autoplaySpeed: 2000,
    ...
    $('.business-way-slide').not('.slick-initialized').slick({
        dots: false,
        infinite: true,
        autoplay: true,
        autoplaySpeed: 2000,
    ...
    $('.portfolio-active').not('.slick-initialized').slick({
        dots: false,
        infinite: true,
        autoplay: true,
        autoplaySpeed: 2000,
