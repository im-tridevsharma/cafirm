        ...
        <div class="col-md-12">
            <div class="card card-user">
                ...
                <div class="card-body">
                    ...
                    @endforeach
                    @endif
                    <form method="POST" enctype="multipart/form-data" action="{{ route('admin.testimonials.save') }}">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Name</label>
                                    <input type="text" class="form-control" value="{{ old('name')??''}}" placeholder="Person Name" name="name">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>Role</label>
                                    <input type="text" class="form-control" value="{{ old('role')??''}}" placeholder="Person Designation" name="role">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Content</label>
                                    <textarea class="form-control textarea" name="content" placeholder="Testimonial">{{ old('content')??''}}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row" id="imagePreview" style="display:none;">
                            <div class="col-md-12">
                                ...
                                <div style="width:100%; height:100px; overflow:hidden;">
                                    <img src="" alt="image-preview" id="imagePrv" style="height:100px;object-fit:contain;" />
                                </div>
                            </div>
                        </div>
                        <div class="row">
