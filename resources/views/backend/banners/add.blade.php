        ...
        <div class="col-md-12">
            <div class="card card-user">
                ...
                <div class="card-body">
                    ...
                    @endforeach
                    @endif
                    <form method="POST" enctype="multipart/form-data" action="{{ route('admin.banners.save') }}">
                        @csrf
                        <div class="row">
                            <div class="col-md-9">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control textarea" name="description" placeholder="Banner Description"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
